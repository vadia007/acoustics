...
<div id="content" class="about-page">
    <div class="inside">
        ...
        <div class="content">
            <div class="info">
                <h3>
                    <?php _e('Разработано для вашего звука');?>
                </h3>
                <p>
                    <strong>Компания Sonitus Acoustics основанная в 2009 году собственником звукозаписыва-ющей студии как результат увлечения.</strong>
                    <br/>
                    <br/>
            ...
            <div class="quote">
                <p>"We are young, open minded and always in pursuit of better quality of our products through new materials and technologies."</p>
                <div class="author">
