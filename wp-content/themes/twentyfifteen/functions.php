...
function twentyfifteen_scripts() {
    ...
    //fancybox
    wp_enqueue_style( 'bxslider', get_template_directory_uri() . '/lib/fancybox/jquery.fancybox.css' );
    ...
    wp_enqueue_script( 'fancybox', get_template_directory_uri() . '/lib/fancybox/jquery.fancybox.js', array( 'jquery' ) );
...
function acoustics_add_new_meta_field() {
...
add_action( 'product_category_add_form_fields', 'acoustics_add_new_meta_field', 10, 2 );

function acoustics_edit_meta_field($term) {
    ...
    $absorbers = esc_attr($term_meta['category_type']) == 'absorbers' ? 'checked' : '';
    $diffusers = $absorbers ? '' : 'checked'; ?>
    <tr class="form-field">
...
add_action( 'product_category_edit_form_fields', 'acoustics_edit_meta_field', 10, 2 );
...
add_action( 'edited_product_category', 'save_taxonomy_custom_meta', 10, 2 );
add_action( 'create_product_category', 'save_taxonomy_custom_meta', 10, 2 );